...
$.ajax({
    ...
    data: {
        key: 'RIABZ-7WR3Q-4X35L-4IFGB-KLN2K-PZBGJ',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(121.49559, 31.25240, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
